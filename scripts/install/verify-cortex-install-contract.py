...
REQUIRED_STATIC_MARKERS = (
    ...
    ("provider-backed Cortex embeddings stay active", "installer reports that provider-backed embeddings do not need the local embed worker"),
    ...
    ("KAIDERA_OS_EDITION", "installer can pin the edition for local dogfood/public builds"),
    ...
    ("edition: $EDITION ($EDITION_SOURCE)", "installer reports the resolved edition and source"),
