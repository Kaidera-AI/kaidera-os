...
//  `group_catalog_models`) + api.py (the key-test / workspace response shapes).
 ...
 * target without ever returning the raw inference key. `provider_ref` is the
 * canonical Manifold test/write target.
 */
