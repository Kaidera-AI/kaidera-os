...
-- Phase 1 foundation: agent-harness skill registry, skill bindings, and rules tables.
-- All tables are project-scoped. Fully idempotent (CREATE TABLE IF NOT EXISTS,
